<nav class="sb-topnav navbar navbar-expand navbar-dark sb-sidenav-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3 mt-2 sb-sidenav-dark" href="index.html"><img src="{{ asset('assets/img/logo1.webp') }}" width="80%" height="auto" alt=""></a>
            <!-- Sidebar Toggle-->
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li>
                          <a class="dropdown-item" href="#!">
                            Hello  @if(auth()->user()->name){{auth()->user()->name}}@endif
                          </a>
                        </li>
